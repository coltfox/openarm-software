...
class RobotControlGUI:
    ...
    def __init__(self, master, joint_limits, demo, COMS, BAUD, init_angles):
        ...
        self.htrack_switch_var = customtkinter.StringVar(value="on")
        self.htrack_switch = customtkinter.CTkSwitch(self.master, text="Track Hand", variable=self.htrack_switch_var,
                                                 onvalue="off", offvalue="on", progress_color=self.themeColor,
                                                 button_color="black")
        self.htrack_switch.place(x=220, y=460)
